                ...
                <>
                    ...
                    <ScrollArea className="lg:!overflow-visible lg:!h-auto h-[400px] mb-8 shadow-inner rounded-xl outline-gray-300 lg:shadow-none">
                        <div
                            ...
                            <ScrollArea
                                className="project-scroll w-[550px] h-[350px] overflow-auto p-3 outline outline-zinc-400 rounded-xl
                                       max-[1000px]:w-[547px] max-[500px]:w-[343px] max-[1000px]:h-fit" >
                                <p>{data.projectDesc}</p>
                                <ul className="mt-2 text-[15px] list-disc list-outside text-left space-y-1">
                                <b className="text-[16px]">Key Features:</b>
